...
//	***	define("SCAN_PATH", '{local Virtual Host}');
	...
	//define("SCAN_PATH", "/home/xixgr/public_html/xixgr_billy/");   //<<<<<<<<<<<<<<<<<<<<<<<
	define("SCAN_PATH", "/home/stereobi/public_html/basis/");  //<<<<<<<<<<<<<<<<<<<<<<<
...
$addresses = array("b.alexiou@stereobit.gr",);// "user2@domain2.com");
...
$skip = array("photo_sm", "photo_md", "photo_bg"); //<<< cp
