...
$addresses = array("balexiou@stereobit.com",) ;//"address2@domain.com");
//$addresses = array("b.alexiou@stereobit.gr",) ;//"address2@domain.com");
...
//	*** define("PATH_DB", '{local path to}'.'/db.php}');
	...
	//define("PATH_DB", "/home/xixgr/public_html/cp/superscan/scandb.php"); //<<<<<
	define("PATH_DB", "/home/stereobi/public_html/cp/superscan/scandb.php"); //<<<<<
} else {
	//define("PATH_DB", "/home/xixgr/public_html/cp/superscan/scandb.php");
	define("PATH_DB", "/home/stereobi/public_html/cp/superscan/scandb.php");
}
