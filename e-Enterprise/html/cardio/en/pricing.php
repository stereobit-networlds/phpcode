	<section id="pricing" class="section">
		<div class="container">
			<div class="row title text-center">
				...
				<h4 class="light white">Choose your favotite plan and sign up today!</h4>
			</div>
					...
					<div class="pricing">
						...
						<div class="box-second active">
							<ul class="white-list text-left">
								...
								<li>Massive e-mail builder</li>
								<li>Unlimited e-mail storage</li>
								<li>10.000 e-mails sending</li>
								<li>Statistics</li>
							</ul>
						</div>
					</div>
