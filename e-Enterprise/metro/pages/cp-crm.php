...
<body class="fixed-top">
   ...
   <!-- END JAVASCRIPTS -->  
   <script>
	function udetails() {var str = arguments[0]; $('#crmdetails').load("cpcrm.php?t=cpcrmusers&id="+str);}
	function cdetails() {var str = arguments[0]; $('#crmdetails').load("cpcrm.php?t=cpcrmcus&id="+str);}
   </script>
