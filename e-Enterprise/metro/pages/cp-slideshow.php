   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="margin-bottom-10 pull-right" id="nestable_list_menu">
						<phpdac>rcslideshow.sliderButtonSelect</phpdac>
			...
			<!-- slider name var -->
			<input type="hidden" id="slidername" name="slidername" value="<phpdac>cmsrt.echostr use slider</phpdac>" />
			<!-- slider name var -->
            <div class="row-fluid">
                <div class="span6">
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-align-left"></i> <phpdac>frontpage.slocale use _currentslider</phpdac></h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <div class="dd" id="nestable_list_1">
                                <ol class="dd-list">
									...
									<phpdac>rcslideshow.readCurrentSlider</phpdac>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="span6">
                    <div class="widget purple">
                        <div class="widget-title">
                            <h4><i class="icon-align-left"></i> <phpdac>rcslideshow.currentSliderName</phpdac></h4>
                            <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                           <!--a href="javascript:;" class="icon-remove"></a-->
                           </span>
                        ...
                        <div class="widget-body">
                            <div class="dd" id="nestable_list_2">
                                <ol class="dd-list">
									<phpdac>rcslideshow.readSelectedSlider</phpdac>
                                </ol>
                            </div>
                        </div>
                    </div>
