...
CREATE TABLE IF NOT EXISTS `cform` (
  ...
  `postform` text CHARACTER SET greek,
  PRIMARY KEY (`id`),
  KEY `email` (`email`)
) ENGINE=MyISAM  DEFAULT CHARSET=greek COMMENT='contact form messages' AUTO_INCREMENT=23 ;
...
DROP TABLE IF EXISTS `pattachments`;
...
CREATE TABLE IF NOT EXISTS `ptags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(128) CHARACTER SET greek NOT NULL,
  `tag` varchar(128) NOT NULL,
  `keywords0` varchar(128) NOT NULL,
  `keywords1` varchar(128) CHARACTER SET greek NOT NULL,
  `keywords2` varchar(128) NOT NULL,
  `descr0` varchar(128) NOT NULL,
  `descr1` varchar(128) CHARACTER SET greek NOT NULL,
  `descr2` varchar(128) NOT NULL,
  `title0` varchar(128) NOT NULL,
  `title1` varchar(128) CHARACTER SET greek NOT NULL,
...
CREATE TABLE IF NOT EXISTS `syncsql` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=greek COMMENT='synchronize sql tables';
...
CREATE TABLE IF NOT EXISTS `wishlist` (
  ...
  UNIQUE KEY `tid` (`tid`),
  KEY `cid` (`cid`)
) ENGINE=MyISAM  DEFAULT CHARSET=greek COMMENT='wishlist table' AUTO_INCREMENT=17 ;
...
CREATE TABLE IF NOT EXISTS `standartmail` (
  ...
  KEY `weight` (`weight`),
  KEY `zone` (`zone`)
) ENGINE=MyISAM  DEFAULT CHARSET=greek COMMENT='standart mail cost array'  ;
